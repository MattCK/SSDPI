...
class AdShotBuilder {
	...
	*/
	constructor(requestedURL: string, storyFinder: boolean, mobile: boolean, belowTheFold: boolean) {
		...
		if ((typeof requestedURL !== 'string') || (requestedURL == "")) {throw "AdShotBuilder.constructor: requestedURL must be a non-empty string";}
	...
	*/
	addCreative(newCreative: Creative) {
