	...
	$( document ).tooltip({
		...
		content: function() {
			...
			if ( element.is( "[rowTag]" ) ) {
				...
				return "Enter the domain URL of a publisher.<br><br> \
						(Ex: nytimes.com, chicagotribune.com)<br><br> \
						Choose the pages for screenshots.<br><br> \
			...
			else if (elementID == "addPagesHelpIcon") { //Deprecated
