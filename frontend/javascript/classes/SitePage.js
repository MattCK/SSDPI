...
class SitePage {
     ...
     * @memberof SitePage
     */
    constructor(parentSiteID, pagesTable, menuItems) {
        ...
        let removeButton = base.nodeFromID(this.removeButtonID());
    ...
    removeFromDOM() {
        ...
        let sitePageRow = base.nodeFromID(this.rowID());
        if (sitePageRow.parentNode) {
            sitePageRow.parentNode.removeChild(sitePageRow);
        }
    }
    /**
    ...
    getAdShotBuilderJSON(creatives) {
        ...
        let requestedURL = base.nodeFromID(this.urlInputID()).value;
        if (requestedURL == "") {
            return [];
        }
     ...
     * @memberof SitePage
     */
    uniqueHTMLID() { return SitePage.UNIQUEHTMLIDPREFIX + this._id; }
    /**
     ...
     * @memberof SitePage
     */
    rowID() { return this.uniqueHTMLID() + SitePage.ROWSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    urlInputID() { return this.uniqueHTMLID() + SitePage.URLINPUTSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    findStoryCheckboxID() { return this.uniqueHTMLID() + SitePage.FINDSTORYCHECKBOXSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    mobileCheckboxID() { return this.uniqueHTMLID() + SitePage.MOBILECHECKBOXSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    belowTheFoldCheckboxID() { return this.uniqueHTMLID() + SitePage.BELOWTHEFOLDCHECKBOXSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    allCreativeRadioID() { return this.uniqueHTMLID() + SitePage.ALLCREATIVERADIOSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    individualCreativeRadioID() { return this.uniqueHTMLID() + SitePage.INDIVIDUALCREATIVERADIOSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    noCreativeRadioID() { return this.uniqueHTMLID() + SitePage.NOCREATIVERADIOSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    creativeRadioTagName() { return this.uniqueHTMLID() + SitePage.CREATIVERADIOTAGNAMESUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    removeButtonID() { return this.uniqueHTMLID() + SitePage.REMOVEBUTTONSUFFIX; }
    /**
     ...
     * @memberof SitePage
     */
    url() { return base.nodeFromID(this.urlInputID()).value; }
    /**
 ...
 * @memberof SitePage
 */
SitePage.UNIQUEHTMLIDPREFIX = "sitePage-";
/**
 ...
 * @memberof SitePage
 */
SitePage.URLINPUTSUFFIX = "-URLInput";
/**
 ...
 * @memberof SitePage
 */
SitePage.FINDSTORYCHECKBOXSUFFIX = "-findStoryCheckbox";
/**
 ...
 * @memberof SitePage
 */
SitePage.MOBILECHECKBOXSUFFIX = "-mobileCheckbox";
/**
 ...
 * @memberof SitePage
 */
SitePage.BELOWTHEFOLDCHECKBOXSUFFIX = "-belowTheFoldCheckbox";
/**
 ...
 * @memberof SitePage
 */
SitePage.ALLCREATIVERADIOSUFFIX = "-allCreativeRadio";
/**
 ...
 * @memberof SitePage
 */
SitePage.INDIVIDUALCREATIVERADIOSUFFIX = "-individualCreativeRadio";
/**
 ...
 * @memberof SitePage
 */
SitePage.NOCREATIVERADIOSUFFIX = "-noCreativeRadio";
/**
 ...
 * @memberof SitePage
 */
SitePage.CREATIVERADIOTAGNAMESUFFIX = "-creativeRadios";
/**
 ...
 * @memberof SitePage
 */
SitePage.REMOVEBUTTONSUFFIX = "-removeButton";
//---------------------------------------------------------------------------------------
//-------------------------------- Static Variables -------------------------------------
//---------------------------------------------------------------------------------------	
