...
var uBlockCollapser = (function() {
    ...
    var onProcessed = function(response) {
        ...
        while ( i-- ) {
            ...
            target.style.setProperty('border', '2px solid blue', 'important');//changed--
    ...
    var hideElements = (function() {
        ...
        if ( document.body.shadowRoot === undefined ) {
            return function(selectors) {
                ...
                while ( i-- ) {
                    elems[i].style.setProperty('border', '2px solid blue', 'important');//changed--
            ...
            while ( i-- ) {
                ...
                if ( shadow !== null ) {
                    if ( shadow.className !== sessionId ) {	
                        elem.style.setProperty('border', '2px solid blue', 'important');//changed--
