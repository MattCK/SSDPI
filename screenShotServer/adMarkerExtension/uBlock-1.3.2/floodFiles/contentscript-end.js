...
var uBlockCollapser = (function() {
    ...
    var onProcessed = function(response) {
        ...
        while ( i-- ) {
            ...
            target.style.setProperty('flood-opacity', '0.9898', 'important');//changed--
    ...
    var hideElements = (function() {
        ...
        if ( document.body.shadowRoot === undefined ) {
            return function(selectors) {
                ...
                while ( i-- ) {
                    elems[i].style.setProperty('flood-opacity', '0.9898', 'important');//changed--
            ...
            while ( i-- ) {
                ...
                if ( shadow !== null ) {
                    if ( shadow.className !== sessionId ) {	
                        elem.style.setProperty('flood-opacity', '0.9898', 'important');//changed--
