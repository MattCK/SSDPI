...
//	final private static String SELENIUMHUBADDRESS = "http://10.100.100.232:4444/wd/hub";
	...
	final private static int TAGTIMEOUT = 14000;			//in milliseconds
...
//	final private static String MOBILEUSERAGENT = "Mozilla/5.0 (iPhone; U; CPU iPhone OS 3_0 like Mac OS X; en-us) AppleWebKit/528.18 (KHTML, like Gecko) Version/4.0 Mobile/7A341 Safari/528.16";
	...
	//---------------------------------------------------------------------------------------
	//********************************* Public Methods **************************************		
	public long takeAdShots(List<AdShotOriginal> adShots) {
...
//				consoleLog("Run Time: " + currentRunTimeMS);
	 ...
	 */
	private void takeAdShot(WebDriver activeSeleniumWebDriver, AdShotOriginal adShot) throws AdShotRunnerException {
...
//			}
	...
	private void addCookiesToSeleniumDriver(WebDriver activeSeleniumWebDriver, List<Cookie> cookiesToAdd, String cookieURL) {
		...
		for(Cookie currentCookie : cookiesToAdd){
			consoleLog("Adding cookie:" + cookieCount);
			++cookieCount;
...
//		
	...
	private void setCookiesforSites(final WebDriver activeSeleniumWebDriver, List<AdShotOriginal> adShots) {
		...
		for (AdShotOriginal currentAdShot: adShots) {
		...
		try {
			...
			if (loginCookie.next()) {
				...
				addCookiesToSeleniumDriver(activeSeleniumWebDriver, loginCookies, loginCookie.getString("SLC_loginPage"));
			}
