...
public class TagImage implements Comparable<TagImage> {
	 ...
	 * @return
	 */
	public static TagImage create(TagImage originalCreative) {
		return new TagImage(originalCreative._imageURL, originalCreative._image, 
							originalCreative._width, originalCreative._height, 
							originalCreative._priority);
	}
	
	public static TagImage fromDatabaseID(int creativeID) {
	 ...
	 */
	private TagImage(String creativeImageURL, BufferedImage creativeImage, 
	...
	private TagImage(ResultSet creativeDetails) throws SQLException {
	 ...
	 */
	@Override
	public int compareTo(TagImage otherCreative) {
