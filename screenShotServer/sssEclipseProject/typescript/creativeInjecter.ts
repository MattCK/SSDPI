...
/** Allows googletag object to be used in Typescript */
declare var googletag: any;

/** Allows adsdiv object to be used in Typescript */
declare var adsDivs: any;

/** Allows yahoo ads object to be used in Typescript */
declare var DARLA_CONFIG: any;
...
class Log {
	 ...
	 * @memberof Log
	 */
	public static output(newMessage: string) {
...
class Creative {
	 ...
	 * @memberof Creative
	 */
	constructor(id: string, imageURL: string, width: number, height: number, priority: number) {
		...
		if (id == "") {throw "Creative.constructor: id must be a non-empty string";}
		if (imageURL == "") {throw "Creative.constructor: imageURL must be a non-empty string";}
		if (width <= 0) {throw "Creative.constructor: width must be an integer greater than 0";}
		if (height <= 0) {throw "Creative.constructor: height must be an integer greater than 0";}
	 ...
	 * @memberof Creative
	 */
	public priority() {return this._priority;}
}
...
class CreativeGroup {
	 ...
	 */
	private readonly _creatives: Set<Creative>;
	 ...
	 * @memberof CreativeGroup
	 */
	private readonly _injectedCreatives: Map<Creative, CICoordinates>;
	...
	*/
	 ...
	 * @memberof CreativeGroup
	 */
	public removeCreative(creativeToRemove: Creative) {
	 ...
	 * @memberof CreativeGroup
	 */
	public getNextUninjectedCreative(width: number, height: number) {
	 ...
	 * @memberof CreativeGroup
	 */
	public injected(injectedCreative: Creative, xPosition: number, yPosition: number) {
	 ...
	 * @memberof CreativeGroup
	 */
	public getCreatives() {return this._creatives;}
	...
	*/
	 ...
	 * @memberof CreativeGroup
	 */
	public getInjectedCreatives() {return this._injectedCreatives;}
}
...
class AdSelector {
	 ...
	 * @memberof AdSelector
	 */
	private readonly _sizes: Set<CreativeSize>;
	 ...
	 * @memberof AdSelector
	 */
	private readonly _hideIfNotReplaced: boolean;
	 ...
	 * @memberof AdSelector
	 */
	constructor(selector: string, hideIfNotReplaced = false) {
	 ...
	 * @memberof AdSelector
	 */
	public addSizes(sizesArray: Array<Array<number>>) {
	 ...
	 * @memberof AdSelector
	 */
	public selector() {return this._selector;}
	 ...
	 * @memberof AdSelector
	 */
	public sizes() {return this._sizes;}
...
class ElementInfo {
	...
	*/
	 ...
	 * @memberof ElementInfo
	 */
	public static xPosition(elementNode: HTMLElement) {
	 ...
	 * @memberof ElementInfo
	 */
	public static yPosition(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static borderWidthBottom(elementNode: HTMLElement) {
	 ...
	 * @memberof ElementInfo
	 */
	public static borderWidthLeft(elementNode: HTMLElement) {
	 ...
	 * @memberof ElementInfo
	 */
	public static borderWidthRight(elementNode: HTMLElement) {
	 ...
	 * @memberof ElementInfo
	 */
	public static borderWidthTop(elementNode: HTMLElement) {
	 ...
	 * @memberof ElementInfo
	 */
	public static floodOpacity(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static marginBottom(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static marginLeft(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static marginRight(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static marginTop(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static paddingBottom(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static paddingLeft(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static paddingRight(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static paddingTop(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static positionStyle(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static zIndex(elementNode: HTMLElement) {
		if (!ElementInfo.isHTMLElement(elementNode)) {return null;}
	 ...
	 * @memberof ElementInfo
	 */
	public static getScreenCoordinates(elementNode: HTMLElement) {
		...
		while (currentFrameElement = <HTMLElement> ElementInfo.getContainingFrame(currentFrameElement)) {
	 ...
	 * @memberof ElementInfo
	 */
	public static getContainingFrame(containedNode: HTMLElement) {
	 ...
	 * @memberof ElementInfo
	 */
	public static isHTMLElement(elementNode: HTMLElement) {
...
class GPTSlots {
	 ...
	 * @memberof GPTSlots
	 */
	private static readonly _TARGETWIDTH = 6420;
	 ...
	 * @memberof GPTSlots
	 */
	private readonly _slots: Array<any>;
	 ...
	 * @memberof GPTSlots
	 */
	private readonly _slotCreativeSizes: Map<any, Set<CreativeSize>>;
	 ...
	 * @memberof GPTSlots
	 */
	private readonly _sizesPropertyKey: string;
	 ...
	 * @memberof GPTSlots
	 */
	private readonly _sizesClass: string;
	 ...
	 * @memberof GPTSlots
	 */
	private readonly _mappingClass: string;
	 ...
	 * @memberof GPTSlots
	 */
	private readonly _viewportClass: string;
	...
	constructor() {
		...
		if ((typeof googletag !== 'undefined') && (typeof googletag.pubads !== 'undefined')) {
			...
			let sizeMappingSlot = this._getDummySlotWithMapping(GPTSlots._TARGETWIDTH, GPTSlots._TARGETHEIGHT,
																GPTSlots._TARGETVIEWPORTWIDTH, GPTSlots._TARGETVIEWPORTHEIGHT);
	 ...
	 * @memberof GPTSlots
	 */
	private _getCreativeSizes(slot: any) {
		...
		let uniqueCreativeSizes = new Set<CreativeSize>();
	 ...
	 * @memberof GPTSlots
	 */
	private _getSizesProperties(slot: any, targetWidth: number, targetHeight: number) {
		...
		let findSize = function(currentObject: any): any {
	 ...
	 * @memberof GPTSlots
	 */
	private _getMappingProperties(slot: any, targetViewportWidth: number, targetViewportHeight: number) {
		...
		//Return after the first matching set is found.
		let cache: Array<object> = [];
		let findViewport = function(currentObject: any): any {
	...
	private _getCreativeSizesInProperty(slotProperty: string) {
		...
		let cache: Array<any> = [];
		let sizes = new Set();
		let findSizes = function(currentObject: any) {
	...
	*/
	private _getViewportInProperty(slotProperty: string) {
	 ...
	 * @memberof GPTSlots
	 */
	private _getMappedSizesInProperty(slotProperty: string) {
	 ...
	 * @memberof GPTSlots
	 */
	private _getDummySlot(targetWidth: number, targetHeight: number) {
...
class CreativeInjecter {
	 ...
	 * @memberof Log
	 */
	private static readonly _ADMARKERFLOODOPACITY = '0.9898';
	 ...
	 */
	private static readonly _SMALLNODEMINWIDTH = 5;
	 ...
	 * @memberof CreativeInjecter
	 */
	private static readonly _SMALLNODEMINHEIGHT = 5;
	 ...
	 * @memberof CreativeInjecter
	 */
	private static readonly _MAXIMUMADKEEPWIDTH = 971;
	...
	//******************************** Private Variables ************************************
	  ...
	  * @memberof CreativeInjecter
	  */
	private readonly _creatives: CreativeGroup;
	 ...
	 * @memberof CreativeInjecter
	 */
	private readonly _adSelectors: Array<AdSelector>;
	 ...
	 * @memberof CreativeInjecter
	 */
	private readonly _injectionStartHeight: number;
	...
	public injectCreativesIntoPage() {
		...
		let markedAdElements: Array<HTMLElement> = Array.from(elementsOfCreativeSizes.get("markedAdElements"));
		let unmarkedIFrames: Array<HTMLElement> = Array.from(elementsOfCreativeSizes.get("unmarkedIFrames"));
	...
	private _replaceElementWithCreative(elementNode: HTMLElement, replacementCreative: Creative) {
		...
		if (elementNode.nodeName == "IFRAME") {
            elementNode = <HTMLElement> elementNode.parentElement;
        }
		...
		this._crawlParentHTMLElements(creativeImage, function(currentNode: HTMLElement) {
	...
	private _hideLargeAdsAndOverlays() {
		...
		this._crawlDocumentHTMLElements(document, function(currentNode: HTMLElement) {
	 ...
	 * @memberof CreativeInjecter
	 */
	private _getPageElementsOfCreativeSizes() {
	 ...
	 * @memberof CreativeInjecter
	 */
	private _getHighestSameSizeContainingFrame(elementNode: HTMLElement) {
		...
		while (currentContainingFrame) {
			...
			currentContainingFrame = <HTMLElement> ElementInfo.getContainingFrame(currentContainingFrame);
		}
	 ...
	 * @memberof CreativeInjecter
	 */
	private _getSmallestContainingParent(startingNode: HTMLElement) {
		...
		this._crawlParentHTMLElements(startingNode, function(currentNode: HTMLElement) {
	...
	private _crawlParentHTMLElements(startingNode: HTMLElement,
		...
		let currentParentNode = <HTMLElement> startingNode.parentNode;
		while (currentParentNode) {
			...
			if (currentParentNode.parentNode) {currentParentNode = <HTMLElement> currentParentNode.parentNode;}

			//Otherwise, if it is a containing frame, make it the current parent node
			else {currentParentNode = <HTMLElement> ElementInfo.getContainingFrame(currentParentNode);}
		}
	}
	 ...
	 * @memberof CreativeInjecter
	 */
	private _sortElementsByPosition(elements: Array<HTMLElement>) {
	 ...
	 * @memberof CreativeInjecter
	 */
	private _sortAdSelectorsByPosition(adSelectors: Array<AdSelector>) {
		...
		let adSelectorSortFunction = function(firstAdSelector: AdSelector, secondAdSelector: AdSelector) {
			...
			//Get the elements
			let firstElement = <HTMLElement> document.querySelector(firstAdSelector.selector());
			let secondElement = <HTMLElement> document.querySelector(secondAdSelector.selector());
