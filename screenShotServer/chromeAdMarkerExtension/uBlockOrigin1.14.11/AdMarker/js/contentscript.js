...
(function() {
    ...
    var batchProcess = function() {
        ...
        for ( var node of changedNodes ) {
            ...
            console.log("Flood Opacity:" + floodOpacity);
            if (
                node[uid_] === undefined ||
                node.clientHeight === 0 || node.clientWidth === 0 || (floodOpacity)
            ) {
                console.log("Continuing:" + floodOpacity);
                continue;
            }
            ...
            node.setAttribute('style', attr + 'flood-opacity: 0.9898 !important;');
        }
        changedNodes.clear();
    };
