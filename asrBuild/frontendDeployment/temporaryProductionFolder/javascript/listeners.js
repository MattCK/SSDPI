/**
* Contains the AdShotRunner listeners to attach functions to the page elements
*
...
$(function() {
	...
	$("#orderSearchTerm").keyup(function(event) {if (event.which == 13) {asr.searchOrders();}});
	...
	$("#customer").on("input", asr.checkCustomerCompletion);
	...
	$("#domain").keyup(function(event) {if (event.which == 13) {asr.getMenu();}});
	...
	$("#addSiteSectionButton").click(asr.addMenuSectionRow);
	$("#addURLButton").click(asr.addURLRow);
